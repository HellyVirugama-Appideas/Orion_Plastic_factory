...
const { saveStep1, saveStep2, saveStep3, finalSignup, verifyOtpAndCreateDriver, createPin, login, verifyPin, updatePersonalDetails, updateRC, deleteAccount, logout, resendOtp, updateLicense } = require("../../controllers/Driver/driverController");
